...
class Probability:
    ...
    """
    Añade una nueva probabilidad al 
    calculador; esta debe contener 
    una clave string y un porcentaje 
    integer.
    """
    ...
    """
    Es una funcion que elije una 
    clave basada en las probabilidades 
    enviadas anteriormente. Si el 
    resultado esta fuera de las 
    probabilidades calculadas
    retornara una clave none; si 
    esta por encima de las
    probabilidades enviara un 
    error.
    """
    def calculate(self):
        TOTAL = 100
