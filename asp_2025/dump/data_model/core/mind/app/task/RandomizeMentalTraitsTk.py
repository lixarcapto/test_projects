...
from data_model.core.mind.app.task.RandomizeLastnameTk import RandomizeLastnameTk
from data_model.core.mind.app.task.RandomizeNameTk import RandomizeNameTk
