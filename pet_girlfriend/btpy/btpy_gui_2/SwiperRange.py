...
class SwiperRange:
    ...
    def set_is_visible_range(self, 
            BOOL:bool):
        self.label_counter.config(
            text = ""
        )
        self.__is_visible_range = BOOL
        self.__update()
    ...
    def __update(self):
        ...
        if(self.__is_visible_range):
            self.__update_range_counter()

    def __update_range_counter(self):
